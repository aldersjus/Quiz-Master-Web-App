...
<body>
	...
	<div>
		...
		<form action="AnswerServlet" method="get" >
			...
			<input type="radio" name="radio" class="radio" value="B"> <%=request.getAttribute("answerWrong")%>
			<input type="radio" name="radio" class="radio" value="A"> <%=request.getAttribute("answer")%>
			<br>
			<input type="submit" name="answer_button" class="button" value="Enter">
